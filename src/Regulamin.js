          ...
          <div className="container">
            <main>
                ...
                <strong>I. Postanowienia ogólne</strong><br/>
                    ...
                    2. Wszystkie produkty w sklepie internetowym sklep-z-telefonami.web.app są fabrycznie nowe, wolne od wad fizycznych i prawnych oraz legalnie wprowadzone na rynek polski.<br/>
                    ...
                    2. Zwracamy faktury w formie elektronicznej.<br/>
                    3. Gdy wystawiamy i przesyłamy faktury elektroniczne, gwarantujemy autentyczność ich pochodzenia oraz integralność treści.<br/>
                    4. Nie odpowiadamy za błędne dane, które wskażesz jako dane do faktury VAT podczas rejestracji lub składania zamówienia.<br/>
                    5. Każdą fakturę elektroniczną dostarczymy na adres e-mail, który podasz podczas rejestracji lub składania zamówienia.<br/>
                    6. Za każdym razem, kiedy składasz zamówienie, możesz zrezygnować z faktury elektronicznej. Jeśli to zrobisz, wystawimy i wyślemy Ci fakturę w formie papierowej.<br/>
                    <br/><br/>
                    ...
                    2. Koszt dostawy wynosi 20 złotych dla każdego zamówienia.<br/>
